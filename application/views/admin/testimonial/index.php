            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="<?=base_url()?>functions/addtestimonial" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Testimonial</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="<?=$grade?> gradeA">
                                            <td><?=++$cnt?>.</td>
                                            <td><?=$rows->testimonial_by?></td>
                                            <td><?=$rows->testimonial?></td>
                                            <td class="center"><?=$visible?></td>
                                            <td class="center">
                                           <a href='<?=base_url()?>functions/edittestimonial/<?=$rows->testimonial_id?>' title="Edit" >
                                            <button class="btn btn-primary btn-sm"><i class="fa fa-edit "></i> Edit</button>
                                            </a>
                                            <a onmousedown='javascript:dlt(this)' href='<?=base_url()?>functions/dlt_testimonial/<?=$rows->testimonial_id?>' title="Delete" onclick="return confirm('Are you sure you want to delete this item?');" >
