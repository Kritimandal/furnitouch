            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="<?=base_url("functions/insert_video")?>" enctype="multipart/form-data">
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>Caption</label>
                  <input type="text" name="video_caption" class="form-control" placeholder="Enter Caption">
                </div>
