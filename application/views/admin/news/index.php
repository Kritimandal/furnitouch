            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="<?=base_url()?>functions/add_news" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add News/Event</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="<?=$grade?> gradeA">
                                            ...
                                            <td class="center"><?=($rows->NewsLive=="Y")?"Visible":"Invisible"?></td>
                                            <td class="center">
                                            <a href="<?=base_url()?>functions/news_edit/<?=$rows->NewsID?>">
                                            <button class="btn btn-primary btn-sm"><i class="fa fa-edit "></i> Edit</button>
                                            </a>
                                            <a  onmousedown='javascript:dlt(this)' href="<?=base_url()?>functions/dlt_news/<?=$rows->NewsID?>" onclick="return confirm('Are you sure you want to delete this item?');">
