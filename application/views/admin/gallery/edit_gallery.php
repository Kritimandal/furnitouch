            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        ?>      
                        <div class="panel-body">
                            <form role="form" method="post" action="<?=base_url('functions/galleryupdate/'.$this->uri->segment('3'))?>" enctype="multipart/form-data">
                <!-- text input -->
                <div class="form-group">
                  <label>Gallery</label>
                  <input type="text" name="Gallery"  class="form-control" placeholder="Enter Name" value="<?=$row->Gallery?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="Description" id="edit" rows="5" cols="80" placeholder="Enter Description"><?=$row->Description?></textarea>
                </div>
