...
class News extends CI_Controller{
	...
	public function index()
	{
		...
		$data["query_latest_programme"]=$this->db->query("SELECT * FROM programmes WHERE ProgrammeLive='Y' order by ProgrammeID desc Limit 0,5");
	...
	public function detail()
	{
		...
		$data["news_detail"] = $this->db->from('news')->where('NewsID',$this->uri->segment(2))->get()->row_array();
